...
PUBLISH_DIR="$SCRIPT_DIR/MarekMotykaBot/bin/Release/net10.0/publish"

echo "==> Publishing solution..."
dotnet publish "$SCRIPT_DIR/MarekMotykaBot/MarekMotykaBot.csproj" -c Release --self-contained false
